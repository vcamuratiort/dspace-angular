...
export class ObjectListComponent {
  ...
  @Input() set objects(objects: RemoteData<PaginatedList<ListableObject>>) {
    ...
    this.communities = this._objects.payload.page[0] && this._objects.payload.page[0].getRenderTypes()[0]['type'] ? this._objects.payload.page[0].getRenderTypes()[0]['type']['value'] == 'community' : false;
